...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
      ...
      children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.only(left: 40.0, top: 60.0, bottom: 20),
            child: Container(
              color: Colors.black,
              child: Row(
                children: <Widget>[
  ...
  child: Column( // Wrap the StaggeredGrid and SingleChildScrollView inside a Column
    children: [
      Padding(
            ...
            child: StaggeredGrid.count(
              ...
              children: [
                ...
                StaggeredGridTile.extent(
                  ...
                  child: MyItems(Icons.graphic_eq, "Reported Scams\n(Mar)", "55", [Color(0xffa8e063), Color(0xffEDE574)],),
                ),
                // SizedBox(height: 26,),
                ...
                StaggeredGridTile.extent(
                  crossAxisCellCount: 1,
                  mainAxisExtent: 150.0,
                  child: MyItems(Icons.graphic_eq, "Confirmed Scams", "25", [Color(0xffa0e6ff), Color(0xffbac8fb)],),
                ),
                // SizedBox(height: 26,),
                ...
                StaggeredGridTile.extent(
                  crossAxisCellCount: 1,
                  mainAxisExtent: 150.0,
                  child: MyItems(Icons.graphic_eq, "Suspicious Scams", "30", [Color(0xfffbe0ff), Color(0xfffeb7bf)],),
                ),
                ...
                StaggeredGridTile.extent(
                  ...
                  child: GestureDetector(
                    ...
                    child: MyItems(
                      Icons.graphic_eq,
                      "View More",
                      "Get more insights about scams",
                      [Color(0xff8BA3E5), Color(0xfff9ccff)],
                    ),
                  ),
                ),
              ],
...
Padding(
  padding: EdgeInsets.symmetric(horizontal: 16.0), // Adjust the padding values as needed
