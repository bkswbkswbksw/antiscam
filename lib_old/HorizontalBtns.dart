    ...
    Padding(
      ...
      child: SingleChildScrollView( // Wrap the Column with SingleChildScrollView
        child: Column(
          ...
          children: [
            _buildRankingTile(1, 'John Doe', 'Gold Medal', Icons.emoji_events, Colors.amber, 4.8, 2),
            SizedBox(height: 16),
            _buildRankingTile(2, 'Jane Smith', 'Silver Medal', Icons.emoji_events, Colors.grey, 4.5, -1),
            SizedBox(height: 16),
            _buildRankingTile(3, 'Alice Johnson', 'Bronze Medal', Icons.emoji_events, Colors.brown, 4.3, 0),
            SizedBox(height: 16),
